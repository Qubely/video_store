...
@section('page')
    <div class="row">
        <div class="col-md-12">
            @can('main_menu_crud_view')
                @if($data['item'] != null || $data['type'] != "edit")
                    <div class="">
                        @include('admin.pages.menu-management.main-menu.crud.fragments._breadcum')
                        
                        <div class="page-block-body">
                            @if($data['type'] == "add")
                                @include('admin.pages.menu-management.main-menu.crud.fragments._actions')
                                <div class="card rounded page-block">
                                    ...
                                    <div id="defaultPage" class="table-list pages">
                                        <div class="mt-2 p-2 p-md-4">
                                            ...
                                            @if(count($data['items']) > 0)
                                                ...
                                                @include('common.view.fragments._pdf-layout',['docTitle' => 'MainMenu List'])
                                                <div class="table-responsive">
                                                    <table class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed" id="dtMainMenu"></table>
                                                </div>
                                            @else
                                    ...
                                    <div id="addPage" class="d-none pages">
                                        @include('admin.pages.menu-management.main-menu.crud.fragments._add')
                                    </div>
                                </div>
                            @else
                                <div id="editPage" class="pages">
                                    <div class="card rounded-0 pb-3">
                                        <div id="loadEdit" class="w-100">
                                            @include('admin.pages.menu-management.main-menu.crud.fragments._edit')
                                        </div>
                                    </div>
                                </div>
                            @endif
